...
import guice.bindings.{AkkaBinding, MonixBinding, PubSubServiceBinding}
import net.codingwell.scalaguice.InjectorExtensions._
import routes.graphql.GraphQLRoutes

object Main extends App {
  val injector = Guice.createInjector(new AkkaBinding(), new MonixBinding(), new PubSubServiceBinding())
